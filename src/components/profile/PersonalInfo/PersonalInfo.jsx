...
export default function PersonalInfo({ data }) {
  ...
  const [postDataUser, { isLoading: isLoadingUser }] = useUpdateUserMutation()
  ...
  return (
    <form className={s.form} action="#">
      ...
      <div className={`${s.formDiv} ${surname !== data?.surname && s.active}`}>
      ...
      <div className={`${s.formDiv} ${email !== data?.email && s.active}`}>
